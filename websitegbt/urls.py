...
urlpatterns = [
    ...
    path('sejarah/', views.sejarah, name='sejarah'),
        ...
        path('lihat-baptis/', views.lihat_baptis,name='lihatbaptis'),

        path('simpan/', views.simpan, name='simpan'),
        path('simpanan/', views.daftar_simpanan, name='simpanan'),
        path('simpanan/hapus/<int:id>/', views.hapus_simpanan, name='hapus_simpanan'),
